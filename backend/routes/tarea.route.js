...
// crear una tarea
router.post('/crear', authenticate, checkWritePermission, createTask);
// modificar una tarea
router.patch('/modificar', authenticate, checkWritePermission, updateTask);
...
router.patch('/eliminar/:id', authenticate, checkWritePermission, deleteTask);
